...
class InventoryCharacterEntity:
    ...
    def __init__(self, character:Character):
        ...
        if (character.loadout.slots[ItemSlotType.WAIST.value] == None): self.legsImg = ImageEntity("img", True, 0, 0, 0, 0, [], "items/leggings_transparent.png")
    ...
    def changeCharacter(self, character:Character):
        ...
        if (character.loadout.slots[ItemSlotType.WAIST.value] == None): self.waistImg.updateImg("items/leggings_transparent.png")
